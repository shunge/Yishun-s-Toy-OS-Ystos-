...
switch_to_pm:
    ...
    cli     ; We must switch of interrupts until we have set-up
            ...
            ; interrupts wilp run riots

    lgdt [gdt_descriptor]   ; Load our glabal descriptor table, which defines
                            ; the protected mode segments (code and data segments)
...
[bits 32]
; Voila! Here you are. Initialise registers and the stack once in PM
